...
if($mt_options['mt_header_h']!="" or $mt_options['mt_header_h']!="80"){ echo ".mt_style_header_1 #header, .mt_style_header_2 #header, .mt_style_header_3 #header { height:"; echo $mt_options['mt_header_h']; echo"px }"; }	
...
.footer_widget_midle ul li a:hover { color: <?php echo $mt_color_type; ?>; }
...
if ( $mt_page_bg !="") { if ( $mt_page_bg['background-color'] !="" ) { $mt_page_bg_color = "yes"; } }
	...
	if($mt_page_bg_image == "yes" and $mt_page_bg_repeat == "yes" or $mt_page_bg_color == "yes" or $mt_page_patterns!="" and $mt_page_patterns!="off" ) {
		...
		if($mt_homepage_bg_p_image['image_upload_test']!="" and $mt_homepage_bg_p_image['background_repeat'] != "full")  {
			...
			if($mt_homepage_bg_p_image['background-position'] != "")		{ echo "body { background_position:"; echo $$mt_homepage_bg_p_image['background_position']; echo "!important;}";  }  			
...
if( get_post_meta($post->ID, "m_title_backgrounds", true) != "") {  ?>
	...
	#header-title { background-image: url(<?php echo $title_bg;  ?>)!important; background:top center; }<?php 
