...
<?php 
$num_pages = 4;
include("../../includes/navtutorial.inc.php"); 
?>
  <div id="content">
  <h1>Click on the <strong>Settings/Preferences</strong> tab. This window sets the defaults for all future virtual tours that you create.</h1>
  <h1>NOTE: All images must be in .jpg format. If you need help converting an image to .jpg, please email the image to me at <a href="mailto:victor@victorlinphoto.com">victor@victorlinphoto.com</a></h1>
  <h3>1. A photo of you has likely already been added. If you want to replace it, upload a new image.</h3>
  <h3>2. Your company logo has likely already been added. If you want to replace it, upload a new image.</h3>
  <h3>3. Adjust the other Tour Branding options to your liking. These affect the look of your tour, so if you're already happy with it, there's no need to change options here. Remember to <strong>Save Tour Branding</strong> when you're done.</h3>
  <p class="tutorialImg"><img src="images/profile_2.JPG" /></p>  
  </div>
