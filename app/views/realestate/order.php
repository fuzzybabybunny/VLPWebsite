...
<b>When loaded onto a Single Property Website, a panoramic photo...</b>
<br />
<br />
  ...
  <div id="content">
    <div id="left_even">
      ...
      <h2><span class="brown2">Please submit an order inquiry and we will get in touch with you. Be sure to note our prices on the right.<br />
        &nbsp;</span></h2>
      <div id="formorder">
      <form method="POST" action="orderconfirm.php" name="enquire" id="enquire" onsubmit="return validations();">
        <div id="left_even">
          ...
          <p style="padding-bottom:5px;">
            <input type="radio" id="sqft" name="sqft" value="Under 1,500 sqft">
            <label for="sqft">Under 1,500 sqft</label>
            <br/>
            <input type="radio" id="sqft" name="sqft" value="1,501 - 2,000 sqft">
            <label for="sqft">1,501 - 2,000 sqft</label>
            <br/>
            <input type="radio" id="sqft" name="sqft" value="2,001 - 3,000 sqft">
            <label for="sqft">2,001 - 3,000 sqft</label>
            <br/>
            <input type="radio" id="sqft" name="sqft" value="3,001 - 4,000 sqft">
            <label for="sqft">3,001 - 4,000 sqft</label>
            <br/>
            <input type="radio" id="sqft" name="sqft" value="">
    ...
    width: 93px;">Estimated Cost<br />
          ...
          <br clear="all" />
          <div class="VTbox">
          <p><em>A traditional "Virtual Tour": </em></p>
            ...
            <?php echo $photosLeft;?>
            <input type="checkbox" id="panoramas" name="panoramas" value="Panoramas / Virtual Tour Effect" amount="20"  onchange=" sum_amount(); return checkbox();" checked>
          ...
          <?php echo $panosLeft;?>
            ...
            <?php echo $spwLeft;?>
            <input id="domain" type="checkbox" name="domain" value="" amount="20" onchange="sum_amount()" />
          ...
          <p style="padding-bottom:5px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input class="inputLeft" name="domainurl" type="text" id="domainurl" value="" amount="20" />
        </p>
          </div>
...
<script type="text/javascript">
document.getElementById("costtotal").innerHTML="25";
...
if((!document.getElementById("hdrphotos").checked) && (!document.getElementById("spw").checked) && (!document.getElementById("domain").checked))
	...
	{
		alert("Professionals used for this Property Required");
		return false;
	}
...
//if(!document.getElementById("domainurl").value.match(url))  
	...
	function checkbox()
	{
		...
		{
			document.getElementById("spw").checked=false;
		}
	}
		...
		function sum_amount()
		{
			...
			if(document.getElementById("tourfactory").checked==true)
			{
				total_sum+=25;
			}
