...
?>
  <div id="content">
   <h1>To edit the details of your tour, click on the <strong>Marketing & VOD</strong> tab.</h1>
    <p class="tutorialImg"><img src="images/tour_15.JPG" alt="" /></p>
   <h1>Click the <strong>Web/Print Marketing</strong> button, and select the checkbox next to the tour you want to download to a CD, and click on the gray <strong>Download to CD</strong> button.</h1>
    <p class="tutorialImg"><img src="images/tour_13.JPG" alt="" /></p> 
    <p class="tutorialImg"><img src="images/tour_25.JPG" alt="" /></p>  
  </div>
