...
?>
  <div id="content">
    <h1>Click on <strong>&gt;&gt; Click Here To Show / Hide The Published Tours For This Listing &gt;&gt;</strong> and decide which tour you want to burn to a CD, the MLS compliant/unbranded verison or the full featured/branded version. </h1>
    <h1>Choose whether you'd like to download an executable (.exe) or a zipped file (.zip). The .zip file builds and downloads a bit quicker than the .exe file.</h1>
    <h1>Press the <strong>Build CD File</strong> button.</h1>
    <p class="tutorialImg"><img src="images/tour_18.JPG" alt="" /></p>   
  </div>
