...
?>
  <div id="content">
  <h1>Upon logging in, click on the <strong>Profile/Settings</strong> tab and then the <strong>Profile/Account</strong> tab.</h1>
  <h1>Update your profile information here.  </h1>
  <h1><strong>NOTE</strong>: Make sure your website is in the form "www.website.com", NOT "http://wwww.website.com". Doing the latter will create an invalid link in the tour.</h1>
  <p class="tutorialImg"><img src="images/profile_1.JPG" /></p>  
  </div>
