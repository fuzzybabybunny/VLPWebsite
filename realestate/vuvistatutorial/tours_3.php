...
?>
  <div id="content">
  	<h1>Click on  the <strong>Add/Edit Listing</strong> tab and enter in all the available house information. <strong>Be sure to add in the house price and MLS number.</strong> When you are done, also make sure to click <strong>Save Listing Information</strong> at the bottom, or else your changes will be lost.</h1>
    <h1><strong>Tour Images</strong></h1>
    <h1>All of your images will have already been uploaded and arranged, but if you would still like to modify or add/delete images, please go to the <a href="images_1.php" target="_self">Add Tour Images</a> tutorial. </h1>
    <p class="tutorialImg"><img src="images/tour_1.JPG" /></p>
  </div>
