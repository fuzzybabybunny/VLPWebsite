...
<title>TourFactory with 126 Generator</title>
</head>
...
echo
'<h2><strong>TourFactory with 126 Staging Generator</strong></h2>
<form action="TourFactory126GeneratorScript.php" method="post">
