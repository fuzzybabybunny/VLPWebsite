...
echo
'<h2><strong>Non-OneTwoSix Link Generator with Invoice</strong></h2>
<form action="VTLinkGeneratorScriptInvoice.php" method="post">
Address: 
<input type="text" size="50" name="address" value="'.$address.'" />
<br />
Gallery: 
<input type="text" size="50" name="gallery" />
<br />
Zip File: 
...
<br />
Receipt or Invoice?
<br /><input type="radio" name="receiptinvoice" value="receipt" /> receipt
<input type="radio" name="receiptinvoice" value="invoice" checked /> invoice<br />
