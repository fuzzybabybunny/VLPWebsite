...
<title>Victor Lin Photography | Contact</title>
<style type="text/css">
<!--
...
<body id="header_small">
<div id="container">
  <div id="header"> <br />
    <br />
    <img src="images/headers/contact_header.jpg" alt="Contact" /></div>
  <div id="nav">
    <div id="nav_left">
      <ul>
    ...
    <div id="nav_right">
      <ul>
        ...
        <li>|</li>
        <li style="margin-right:0px;"><a href="contact.php" class="navon"><img src="images/nav/nav_contact.jpg" alt="Real Estate" /></a></li>
      </ul>
    </div>
  </div>
  <div id="content">
    <div id="formleft">
      <h1>To discuss your photographic needs or to find out more, please get in touch.</h1><br/>
      <h1><b>To place an order and to see pricing, go <a href="http://victorlinphoto.com/realestate/prices.php">HERE</a>.</h1></b><br />
      <h2><span class="white">Email (fastest): </span><br />
        <span class="brown"><a class="white" href="mailto:victor@victorlinphoto.com">victor@victorlinphoto.com</a></span></h2>
        <h2><span class="brown2">Telephone:<br />
        </span>(650) - 248 - 0289</h2><br />
    </div>
    <div id="formright">
      <div id="formmain">
        <h1>Contact</h1>
        <p>Submission was a success! Thank you for contacting me. I will be sure to get back to you shortly. </p>
        <p><a href="contact.php">BACK</a></p>
        <form method="POST" action="contact.php" name="enquire" id="enquire">
          <br clear="all" />
        </form>
      </div>
    </div>
