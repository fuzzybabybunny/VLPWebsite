...
?>
  <div id="content">
  <h1>Click on the <strong>Marketing & VOD</strong> tab.</h1>
    <p class="tutorialImg"><img src="images/tour_15.JPG" alt="" /></p>
   <h1>Click on the <strong>Web/Print Marketing</strong> button, select the checkbox next to the tour you want to create a flyer for, and click on the gray <strong>Flyer</strong> button.</h1>
