...
?>
  <div id="content">
  <h1>You can add your email or make email groups for emailing Reports/Postcards to.</h1>
  <h1>To set up email, click on the <strong>Import Emails </strong>tab.</h1>
  <h3>1. Add email information under the <strong>Emails to Import</strong> section.</h3>
  <h3>2. Click the<strong> Add </strong>button.</h3>
  <h3>3. The email you just added will now be visible under the <strong>Main List</strong> section.  </h3>
  <h3>4. Continue to add however many emails you want.  </h3>
  <p class="tutorialImg"><img src="images/profile_3.JPG" /></p>  
  </div>
